    ...
    static void basic(MainManager m) throws Exception
    {
        ...
        while(true) {
            if (user == null) {
                ...
                System.out.println("5 - вывести избранное");
                System.out.println("6 - вывести чёрный список");
                    ...
                    if (list.size() > 0) {
                        ...
                        if (activeQuest != null) {
                            ...
                            if (y.equals("1")) {
                                ...
                                AQuestionnaire quest = m.getM_que_manager().findQuestionnaire(number);
                                m.getM_rec_manager().recommended_questionnaires(activeQuest, (List<AQuestionnaire>) quest);
                ...
                if (y.equals("3")) {
                    ...
                    System.out.println("Анкета помечена цензурированой.");
                }
            }
